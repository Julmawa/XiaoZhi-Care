...
// Language: es-ES with en-US fallback
#pragma once
...
namespace Lang {
    // 语言元数据
    constexpr const char* CODE = "es-ES";

    // 字符串资源 (en-US as fallback for missing keys)
    namespace Strings {
        constexpr const char* ACCESS_VIA_BROWSER = "，acceder mediante navegador ";
        constexpr const char* ACTIVATION = "Activación del dispositivo";
        constexpr const char* BATTERY_CHARGING = "Cargando";
        constexpr const char* BATTERY_FULL = "Batería llena";
        constexpr const char* BATTERY_LOW = "Batería baja";
        constexpr const char* BATTERY_NEED_CHARGE = "Batería baja, por favor cargar";
        constexpr const char* CHECKING_NEW_VERSION = "Verificando nueva versión...";
        constexpr const char* CHECK_NEW_VERSION_FAILED = "Error al verificar nueva versión, reintentando en %d segundos: %s";
        constexpr const char* CONNECTED_TO = "Conectado a ";
        constexpr const char* CONNECTING = "Conectando...";
        constexpr const char* CONNECTION_SUCCESSFUL = "Conexión exitosa";
        constexpr const char* CONNECT_TO = "Conectar a ";
        constexpr const char* CONNECT_TO_HOTSPOT = "Conectar teléfono al punto de acceso ";
        constexpr const char* DETECTING_MODULE = "Detectando módulo...";
        constexpr const char* DOWNLOAD_ASSETS_FAILED = "Error al descargar recursos";
        constexpr const char* ENTERING_WIFI_CONFIG_MODE = "Entrando en modo configuración de red...";
        constexpr const char* ERROR = "Error";
        constexpr const char* FLIGHT_MODE_OFF = "El modo avión está desactivado";
        constexpr const char* FLIGHT_MODE_ON = "El modo avión está activado";
        constexpr const char* FOUND_NEW_ASSETS = "Encontrados nuevos recursos: %s";
        constexpr const char* HELLO_MY_FRIEND = "¡Hola, mi amigo!";
        constexpr const char* INFO = "Información";
        constexpr const char* INITIALIZING = "Inicializando...";
        constexpr const char* LISTENING = "Escuchando...";
        constexpr const char* LOADING_ASSETS = "Cargando recursos...";
        constexpr const char* LOADING_PROTOCOL = "Conectando al servidor...";
        constexpr const char* MAX_VOLUME = "Volumen máximo";
        constexpr const char* MODEM_INIT_ERROR = "Error de inicialización del módem";
        constexpr const char* MUTED = "Silenciado";
        constexpr const char* NEW_VERSION = "Nueva versión ";
        constexpr const char* OTA_UPGRADE = "Actualización OTA";
        constexpr const char* PIN_ERROR = "Por favor inserte la tarjeta SIM";
        constexpr const char* PLEASE_WAIT = "Por favor espere...";
        constexpr const char* REGISTERING_NETWORK = "Esperando red...";
        constexpr const char* REG_ERROR = "No se puede acceder a la red, verifique el estado de la tarjeta de datos";
        constexpr const char* RTC_MODE_OFF = "AEC desactivado";
        constexpr const char* RTC_MODE_ON = "AEC activado";
        constexpr const char* SCANNING_WIFI = "Escaneando Wi-Fi...";
        constexpr const char* SERVER_ERROR = "Error de envío, verifique la red";
        constexpr const char* SERVER_NOT_CONNECTED = "No se puede conectar al servicio, inténtelo más tarde";
        constexpr const char* SERVER_NOT_FOUND = "Buscando servicio disponible";
        constexpr const char* SERVER_TIMEOUT = "Tiempo de espera agotado";
        constexpr const char* SPEAKING = "Hablando...";
        constexpr const char* STANDBY = "En espera";
        constexpr const char* SWITCH_TO_4G_NETWORK = "Cambiando a 4G...";
        constexpr const char* SWITCH_TO_WIFI_NETWORK = "Cambiando a Wi-Fi...";
        constexpr const char* UPGRADE_FAILED = "Actualización fallida";
        constexpr const char* UPGRADING = "Actualizando sistema...";
        constexpr const char* VERSION = "Versión ";
        constexpr const char* VOLUME = "Volumen ";
        constexpr const char* WARNING = "Advertencia";
        constexpr const char* WIFI_CONFIG_MODE = "Modo configuración de red";
    }
