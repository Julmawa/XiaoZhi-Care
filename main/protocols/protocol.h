...
enum ListeningMode {
    ...
    // DP-039: server receives this as manual mode; the ESP32 ends the turn
    // locally after a longer VAD silence suitable for slow/paused speech.
    kListeningModeCareSlow,
