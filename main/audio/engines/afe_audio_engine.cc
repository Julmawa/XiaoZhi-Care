...
bool AfeAudioEngine::Initialize(AudioCodec* codec, int frame_duration_ms,
    ...
    // MODE_1 is only one step more restrictive, preserving quiet speech better
    // than jumping directly to MODE_2/3.
    // DP-039 Fase 1C: MODE_1 siguio quedando pegado en SPEECH en el hardware CARE.
    // Probamos MODE_2 para rechazar mejor ruido constante sin saltar aun a MODE_3.
    ...
    processing_task_ = xTaskCreateStatic(
        ...
        "audio_afe", kProcessingTaskStackSize, this, 6, processing_task_stack_,
        processing_task_buffer_);
