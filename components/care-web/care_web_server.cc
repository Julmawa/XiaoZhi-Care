...
esp_err_t CareWebServer::Start() {
    ...
    const struct {
        ...
        {"/api/maintenance/audio-volume", HTTP_PUT, HandleMaintenanceAudioVolume},
        {"/api/maintenance/news-settings", HTTP_PUT, HandleMaintenanceNewsSettings},
        ...
        {"/api/vitals/blood-pressure", HTTP_GET, HandleBloodPressureList},
        {"/api/vitals/blood-pressure", HTTP_POST, HandleBloodPressureCreate},
        {"/api/vitals/blood-pressure/*", HTTP_GET, HandleBloodPressureGet},
        {"/api/vitals/blood-pressure/*", HTTP_PUT, HandleBloodPressureUpdate},
        {"/api/vitals/blood-pressure/*", HTTP_DELETE, HandleBloodPressureDelete},
