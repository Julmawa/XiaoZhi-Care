...
public:
    ...
    std::string ConfirmPillboxGroup(const std::string& group_id);
    std::string VerifyPillboxGroup(const std::string& group_id,
                                   const std::string& result);
    std::string GetReminders(const std::string& date = "");
    std::string AddTodoReminder(const std::string& text,
